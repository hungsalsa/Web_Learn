   ...
   <?php if (empty($productInfo)): ?>
      <div class="detail-block">
         <div class="row  wow fadeInUp">
            <h1 class="name">Khong co san pham nay</h1>
         </div>
      </div>
   <?php else: ?>
      ...
      <div class="row  wow fadeInUp">
         ...
         <div class='col-sm-6 col-md-7 product-info-block'>
            <div class="product-info">
               <h1 class="name"><?= $productInfo['productName'] ?></h1>
               ...
               <div class="price-container info-container m-t-20">
                  <div class="row">
                     <div class="col-sm-6">
                        <div class="price-box">
                           <span class="price">$<?= $productInfo['priceSale'] ?></span>
                           <span class="price-strike">$<?= $productInfo['price'] ?></span>
                        </div>
                     </div>
                     <div class="col-sm-6">
            ...
            <div class="tab-content">
               <div id="description" class="tab-pane in active">
                  <div class="product-tab">
                     <p class="text"><?= $productInfo['content'] ?></p>
                  </div>
               </div>
               <!-- /.tab-pane -->
            ...
            <div class="products">
               <div class="product">
                  <div class="product-image">
                     <div class="image">
                        <a href="detail.html"><img  src="<?= yii::$app->homeUrl; ?>common/images/products/p1.jpg" alt=""></a>
                     </div>
                     <!-- /.image -->        
         ...
         <div class="item item-carousel">
            <div class="products">
               <div class="product">
                  <div class="product-image">
                     <div class="image">
                        <a href="detail.html"><img  src="<?= yii::$app->homeUrl; ?>common/images/products/p2.jpg" alt=""></a>
                     </div>
                     <!-- /.image -->        
                     <div class="tag sale"><span>sale</span></div>
                  </div>
         ...
         <div class="item item-carousel">
            <div class="products">
               <div class="product">
                  <div class="product-image">
                     <div class="image">
                        <a href="detail.html"><img  src="<?= yii::$app->homeUrl; ?>common/images/products/p3.jpg" alt=""></a>
                     </div>
                     <!-- /.image -->        
         ...
         <div class="item item-carousel">
            <div class="products">
               <div class="product">
                  <div class="product-image">
                     <div class="image">
                        <a href="detail.html"><img  src="<?= yii::$app->homeUrl; ?>common/images/products/p4.jpg" alt=""></a>
                     </div>
                     <!-- /.image -->        
         ...
         <div class="item item-carousel">
            <div class="products">
               <div class="product">
                  <div class="product-image">
                     <div class="image">
                        <a href="detail.html"><img  src="<?= yii::$app->homeUrl; ?>common/images/blank.gif" data-echo="<?= yii::$app->homeUrl; ?>common/images/products/p5.jpg" alt=""></a>
                     </div>
                     <!-- /.image -->        
                     <div class="tag hot"><span>hot</span></div>
                  </div>
         ...
         <div class="item item-carousel">
            <div class="products">
               <div class="product">
                  <div class="product-image">
                     <div class="image">
                        <a href="detail.html"><img  src="<?= yii::$app->homeUrl; ?>common/images/blank.gif" data-echo="<?= yii::$app->homeUrl; ?>common/images/products/p6.jpg" alt=""></a>
                     </div>
                     <!-- /.image -->        
                     <div class="tag new"><span>new</span></div>
                  </div>
